...
NOTE: Data integration code and data are available in the [`LTMRdata`](https://github.com/sbashevkin/LTMRdata) package.

# Univariate analyses

Code for chapter 6 of the 2020 IEP Long Term Monitoring Review Technical Report. 
